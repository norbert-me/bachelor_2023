...
methodDraw.addExtension("shapes", function () {
  ...
  var library = {
    'basic': {
      data: {
        ...
        "rectangle": "m1,299l0,-298l298,0l0,298z",
        "right_triangle": "m1,299l0,-298l298,298z",
        "circle": "M1 150C1 67.71 67.71 1 150 1a149 149 0 0 1 149 149c0 82.29-66.71 149-149 149S1 232.29 1 150z",
  ...
  function makeButtons(cat, shapes) {
    ...
    var shape_icon = new DOMParser().parseFromString( //load new form
      '<svg xmlns="http://www.w3.org/2000/svg"><svg viewBox="' + vb + '"><path fill="#33" stroke="transparent" stroke-width="' + stroke + '" /><\/svg><\/svg>',
      'text/xml');
  ...
  return {
    ...
    buttons: [{
      id: "tool_shapelib", //load basic shapes
    ...
    callback: function () {
      ...
      $('#shape_buttons').mouseup(function (evt) {
        ...
        var copy = btn.children().clone().attr({ width: 27, height: 27 });
