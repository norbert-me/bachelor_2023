    ...
    function (options) {
      ...
      return this.each(function () {
        ...
        gradPicker.html(
          ...
          '<label class="jGraduate_Form_Heading">Startpunkt</label>' +
          '<div class="jGraduate_Form_Section">' +
          '<label>x:</label>' +
          '<input type="text" id="' + id + '_jGraduate_x1" size="3" title="Gib einen x-Wert zwischen 0.0 und 1.0"/>' +
          '<label> y:</label>' +
          '<input type="text" id="' + id + '_jGraduate_y1" size="3" title="Gib einen y-Wert zwischen 0.0 und 1.0"/>' +
          '</div>' +
          '</div>' +
          '<div class="jGraduate_StopSection">' +
          '<label class="jGraduate_Form_Heading">Endpunkt</label>' +
          '<div class="jGraduate_Form_Section">' +
          '<label>x:</label>' +
          '<input type="text" id="' + id + '_jGraduate_x2" size="3" title="Gib einen x-Wert zwischen 0.0 und 1.0"/>' +
          '<label> y:</label>' +
          '<input type="text" id="' + id + '_jGraduate_y2" size="3" title="Gib einen y-Wert zwischen 0.0 und 1.0"/>' +
          '</div>' +
          '</div>' +
          '</div>' +
          '<div class="jGraduate_Form jGraduate_Points jGraduate_rg_field">' +
          '<div class="jGraduate_StopSection">' +
          '<label class="jGraduate_Form_Heading">Mittelpunkt</label>' +
          '<div class="jGraduate_Form_Section">' +
          '<label>x:</label>' +
          '<input type="text" id="' + id + '_jGraduate_cx" size="3" title="Gib einen x-Wert zwischen 0.0 und 1.0"/>' +
          '<label> y:</label>' +
          '<input type="text" id="' + id + '_jGraduate_cy" size="3" title="Gib einen y-Wert zwischen 0.0 und 1.0"/>' +
          '</div>' +
          '</div>' +
          '<div class="jGraduate_StopSection">' +
          '<label class="jGraduate_Form_Heading">Fokuspunkt</label>' +
          '<div class="jGraduate_Form_Section">' +
          '<label>wie Mitte: <input type="checkbox" checked="checked" id="' + id + '_jGraduate_match_ctr"/></label><br/>' +
          '<label>x:</label>' +
          '<input type="text" id="' + id + '_jGraduate_fx" size="3" title="Gib einen x-Wert zwischen 0.0 und 1.0"/>' +
          '<label> y:</label>' +
          '<input type="text" id="' + id + '_jGraduate_fy" size="3" title="Gib einen y-Wert zwischen 0.0 und 1.0"/>' +
          '</div>' +
          '</div>' +
          '</div>' +
          '<div class="jGraduate_StopSection jGraduate_SpreadMethod">' +
          '<label class="jGraduate_Form_Heading">Streumethode</label>' +
          '<div class="jGraduate_Form_Section">' +
          '<select class="jGraduate_spreadMethod">' +
          '<option value=pad selected>Pad</option>' +
          '<option value=reflect>Reflektieren</option>' +
          ...
          '<div id="' + id + '_jGraduate_Radius" class="jGraduate_SliderBar jGraduate_Radius" title="Klicken um Radius zu setzen">' +
          ...
          '<label class="prelabel">Ellipse:</label>' +
          '<div id="' + id + '_jGraduate_Ellip" class="jGraduate_SliderBar jGraduate_Ellip" title="Klicken um Ellipse zu setzen">' +
          ...
          '<label class="prelabel">Winkel:</label>' +
          '<div id="' + id + '_jGraduate_Angle" class="jGraduate_SliderBar jGraduate_Angle" title="Klicken um Winkel zu setzen">' +
          ...
          '<label class="prelabel">Deckkraft:</label>' +
          '<div id="' + id + '_jGraduate_Opac" class="jGraduate_SliderBar jGraduate_Opac" title="Klicken um Deckkraft zu setzen">' +
          ...
          '<input type="button" id="' + id + '_jGraduate_Cancel" class="jGraduate_Cancel" value="Abbrechen"/>' +
          '</div>');
        ...
        setTimeout(function () {
          ...
          $("#color_picker").css({ 'left': left, 'top': top });
        }, 10);
      });
    };
})();