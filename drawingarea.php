   ...
   <div id="svg_editor">
      ...
      ?>
         <div id="menu_bar">
            ...
            <div class="menu">
               <div class="menu_title" id="menu_title"><?php print_string('file', 'qtype_drawing'); ?></div>
               <div class="menu_list" id="file_menu">
                  <div id="tool_clear" class="menu_item"><?php print_string('erasedrawing', 'qtype_drawing'); ?></div>
               </div>
            </div>
            <div class="menu">
               <div class="menu_title" id="menu_title"><?php print_string('edit', 'qtype_drawing'); ?></div>
            ...
            <div class="menu">
               <div class="menu_title" id="menu_title"><?php print_string('object', 'qtype_drawing'); ?></div>
            ...
            <div class="menu">
               <div class="menu_title" id="menu_title"><?php print_string('view', 'qtype_drawing'); ?></div>
      ...
      <div id="tools_top" class="tools_panel">
         ...
         <div id="canvas_panel" class="context_panel">
            ...
            <div class="stroke_tool draginput" style="width:145px;padding-bottom:2px; height:auto" id="fastcolorpicks">
               ...
               <div style="margin-top:15px; text-align:center;">
                  ...
                  <div id="qtype_drawing_tool_color14" class="qtype_drawing_color_pallette" data-strokeorfill="stroke">
                     <img id="open_picker" src="images/colors.png" width="22" height="22" alt="C">
                  </div>
                  <div id="qtype_drawing_tool_color15" class="qtype_drawing_color_pallette" data-strokeorfill="fill">
                     <img id="open_picker" src="images/paintbucket.png" width="22" height="22" alt="B">
                  </div>
               </div>
            </div>
            <!-- Penicil size-->
            ...
            <div id="stroke_panel" class=" clearfix">
               ...
               <?php
               if ($reducedmode == 1) { ?> <div id="force_remove_stroke_style" style="display:none"> <?php } ?>
      ...
      <div id="tools_left" class="tools_panel">
         ...
         <?php } ?>
         <div id="color_tools" <?php if ($reducedmode == 1) { ?> style="display:none;" <?php } ?>>
         ...
         <!-- Save tool 
         <div class="tool_button" id="tool_source_save" title="Speichern"></div> -->
      </div>
      <!-- tools_left -->
