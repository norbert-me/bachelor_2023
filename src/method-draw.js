    ...
    Editor.init = function () {
      ...
      document.onmouseup = function(e){
        if(e.target.id === 'svgroot' ||
          e.target.id === 'workarea' ||
          e.target.id === 'tools_left' ||
          e.target.id === 'tools_top' ||
          e.target.id === 'tools_bottom' ||
          e.target.id === 'menu_bar' ||
          e.target.id === 'qtype_drawing_tool_color1' ||
          e.target.id === 'qtype_drawing_tool_color2' ||
          e.target.id === 'qtype_drawing_tool_color3' ||
          e.target.id === 'qtype_drawing_tool_color4' ||
          e.target.id === 'qtype_drawing_tool_color5' ||
          e.target.id === 'qtype_drawing_tool_color6' ||
          e.target.id === 'qtype_drawing_tool_color7' ||
          e.target.id === 'qtype_drawing_tool_color8' ||
          e.target.id === 'qtype_drawing_tool_color9' ||
          e.target.id === 'qtype_drawing_tool_color10' ||
          e.target.id === 'qtype_drawing_tool_color11' ||
          e.target.id === 'qtype_drawing_tool_color12' ||
          e.target.id === 'qtype_drawing_tool_color13' ||
          e.target.id === 'tool_switch' ||
          e.target.id === 'menu_title' ||
          e.target.id === 'preset_sizes_panel_id' ||
          e.target.id === 'fastcolorpicks' ||
          e.target.parentNode.id === 'svgroot' ||
          e.target.parentNode.id === 'workarea' ||
          e.target.parentNode.id === 'tools_left' ||
          e.target.parentNode.id === 'tools_top' ||
          e.target.parentNode.id === 'tools_bottom' ||
          e.target.parentNode.id === 'preset_sizes_panel_id' ||
          e.target.parentNode.id === 'qtype_drawing_tool_pensize1' ||
          e.target.parentNode.id === 'qtype_drawing_tool_pensize2' ||
          e.target.parentNode.id === 'qtype_drawing_tool_pensize3' ||
          e.target.parentNode.id === 'qtype_drawing_tool_pensize4' ||
          e.target.parentNode.id === 'qtype_drawing_tool_pensize5' ||
          e.target.parentNode.id === 'qtype_drawing_tool_pensize6' ||
          e.target.parentNode.id === 'menu_bar'){
          if(document.getElementById('color_picker').style.display == 'block'){
      ...
      var setupFlyouts = function (holders) {
        $.each(holders, function (hold_sel, btn_opts) {
          ...
          shower.mousedown(function (evt) {
            if($("#color_picker").is(":visible")) return;
      ...
      $('#workarea').on('mousewheel', function (e, delta, deltaX, deltaY) {
        if (e.ctrlKey) {
          ...
          $("#zoom").val(parseInt(zoom + deltaY * 12)).change()
        }
      });
      ...
      var saveSourceEditor = function () {
        ...
        if (!svgCanvas.setSvgString($('#svg_source_textarea').val())) { //Edit
      ...
      var colorPicker = function (elem) {
        if($("#tools_shapelib").is(":visible")) return;
      ...
      var Actions = function () {
        var tool_buttons = [
          { sel: '#tool_select', fn: clickSelect, evt: 'mouseup', key: ['V', true] },
          { sel: '#tool_fhpath', fn: clickFHPath, evt: 'mouseup', key: ['Q', true] },
          { sel: '#tool_line', fn: clickLine, evt: 'mouseup', key: ['L', true] },
          { sel: '#tool_rect', fn: clickRect, evt: 'mouseup', key: ['R', true], icon: 'rect' },
          { sel: '#tool_ellipse', fn: clickEllipse, evt: 'mouseup', key: ['C', true], icon: 'ellipse' },
          // Preset Sizes - Amr
          { sel: '.qtype_drawing_size_pen', fn: quicksizechange, evt: 'mouseup' },
          // Preset Colors - Amr
          { sel: '.qtype_drawing_color_divsquare', fn: clickquickcolor, evt: 'mouseup' },
          { sel: '.qtype_drawing_color_pallette', fn: quickcolorpallette, evt: 'mouseup' },
          { sel: '#tool_path', fn: clickPath, evt: 'mouseup', key: ['P', true] },
          { sel: '#tool_text', fn: clickText, evt: 'mouseup', key: ['T', true] },
          ...
          { sel: '#tool_saveannotation', fn: clickSaveannotation, evt: 'mouseup' },
          { sel: '.tool_showannotation', fn: clickShowannotation, evt: 'mouseup' },
          { sel: '#showoriginalanswer', fn: clickShowannotation, evt: 'mouseup' },
          { sel: '#tool_export', fn: clickExport, evt: 'mouseup' },
          { sel: '#tool_open', fn: clickOpen, evt: 'mouseup' },
          { sel: '#tool_import', fn: clickImport, evt: 'mouseup' },
          { sel: '#tool_source', fn: showSourceEditor, evt: 'mouseup', key: [modKey + 'U', true] },
          { sel: '#tool_wireframe', fn: clickWireframe, evt: 'mouseup' },
          { sel: '#tool_snap', fn: clickSnapGrid, evt: 'mouseup' },
          { sel: '#tool_rulers', fn: clickRulers, evt: 'mouseup' },
          { sel: '#tool_source_cancel,#svg_source_overlay,#tool_docprops_cancel,#tool_prefs_cancel', fn: cancelOverlays, evt: 'mouseup', key: ['esc', false, false], hidekey: true },
          { sel: '#tool_source_save', fn: saveSourceEditor, evt: 'mouseup' },
          { sel: '#tool_delete,#tool_delete_multi', fn: deleteSelected, evt: 'mouseup', key: ['del/backspace', true] },
          { sel: '#tool_reorient', fn: reorientPath, evt: 'mouseup' },
          { sel: '#tool_node_link', fn: linkControlPoints, evt: 'change' },
          { sel: '#tool_node_clone', fn: clonePathNode, evt: 'mouseup' },
          { sel: '#tool_node_delete', fn: deletePathNode, evt: 'mouseup' },
          { sel: '#tool_openclose_path', fn: opencloseSubPath, evt: 'mouseup' },
          { sel: '#tool_add_subpath', fn: addSubPath, evt: 'mouseup' },
          { sel: '#tool_move_top', fn: moveToTopSelected, evt: 'mouseup', key: modKey + 'shift+up' },
          { sel: '#tool_move_bottom', fn: moveToBottomSelected, evt: 'mouseup', key: modKey + 'shift+down' },
          { sel: '#tool_move_up', fn: moveUpSelected, evt: 'mouseup', key: [modKey + 'up', true] },
          { sel: '#tool_move_down', fn: moveDownSelected, evt: 'mouseup', key: [modKey + 'down', true] },
          { sel: '#tool_topath', fn: convertToPath, evt: 'mouseup' },
          { sel: '#tool_make_link,#tool_make_link_multi', fn: makeHyperlink, evt: 'mouseup' },
          { sel: '#tool_clone,#tool_clone_multi', fn: clickClone, evt: 'mouseup', key: [modKey + 'D', true] },
          { sel: '#tool_group', fn: clickGroup, evt: 'mouseup', key: [modKey + 'G', true] },
          { sel: '#tool_ungroup', fn: clickGroup, evt: 'mouseup', key: modKey + 'shift+G' },
          { sel: '#tool_unlink_use', fn: clickGroup, evt: 'mouseup' },
          { sel: '[id^=tool_align]', fn: clickAlign, evt: 'mouseup' },
          { sel: '#tool_undo', fn: clickUndo, evt: 'mouseup', key: modKey + 'z' },
          { sel: '#tool_redo', fn: clickRedo, evt: 'mouseup', key: ['y', true] },
          { sel: '#tool_bucket', fn: clickFill, evt: 'mouseup' },
          { sel: '#tool_cut', fn: cutSelected, evt: 'mouseup', key: [modKey + 'x', true] },
          { sel: '#tool_copy', fn: copySelected, evt: 'mouseup', key: modKey + 'c' },
          { sel: '#tool_paste', fn: pasteSelected, evt: 'mouseup', key: modKey + 'v' },
          { sel: '#tool_switch', fn: clickSwitch, evt: 'mouseup', key: ['x', true] },
          { sel: '#tool_bold', fn: clickBold, evt: 'mouseup', key: [modKey + 'B', true] },
          { sel: '#tool_italic', fn: clickItalic, evt: 'mouseup', key: [modKey + 'I', true] },
          { sel: '#copy_save_done', fn: cancelOverlays, evt: 'mouseup' },
